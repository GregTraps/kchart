...
function LoadPushFuturemarketDepthAnd(buyDepthList,sellDepthList,recentDealList){
	...
	if(buyDepthList == null &&  sellDepthList == null){
		return;
	}
    ...
    var medianUnit = sortDepth.medianUnit(buyDepthList, sellDepthList, 30);
    ...
    if(buyDepthList != null){
        ...
        for(var i=0;i<buyDepthList.length;i++) {
			...
			//	default:break;
			//}
			document.getElementById("buySpanColor" + y).style.width = sortDepth.width(buyDepthList[i][1],medianUnit) + "px";
    ...
    if(sellDepthList != null){
        ...
        for(var i=sellDepthList.length-1;i>=0;i--) {
			...
			//	default:break;
			//}
			document.getElementById("sellSpanColor" + y).style.width = sortDepth.width(sellDepthList[i][1],medianUnit) + "px";
